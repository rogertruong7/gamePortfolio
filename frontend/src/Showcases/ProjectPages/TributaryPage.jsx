        ...
        <List>
          <StyledTable>
              ...
              <StyledTd>
                <ul>
                  ...
                  <li>
                    ...
                    topic. While this can be any type in Java, for the purposes
                    of the CLI it can either be <code>Integer</code> or{" "}
                    <code>String</code>.
                  </li>
                </ul>
              </StyledTd>
            ...
            <tr>
              ...
              <StyledTd>
                A message confirming the partition’s creation.
              </StyledTd>
            </tr>
            <tr>
              <StyledTd>
              ...
              <StyledTd>
                <ul>
                  <li>
                    Creates a new consumer group with the given identifier.
                  </li>
                  <li>
            ...
            <tr>
              ...
              <StyledTd>
                A message confirming the consumer’s deletion, and an output of
                the rebalanced consumer group that the consumer was previously
                in.
              </StyledTd>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <StyledTd>
                <ul>
                  ...
                  <li>
                    How you represent the event is up to you. We recommend using
                    a JSON structure to represent the different parts of an
                    event and the
                    <code>event</code> parameter to this command is a filename
                    to a JSON file with the event content inside.
                  </li>
                  <li>
            ...
            <tr>
              ...
              <StyledTd>
                <ul>
                  <li>
                    The given consumer consumes an event from the given
                    partition. Precondition: The consumer is already allocated
            ...
            <tr>
              <StyledTd>
                <code>
                  consume events &lt;consumer&gt; &lt;partition&gt; &lt;number
                  of events&gt;
                </code>
              </StyledTd>
              <StyledTd>
            ...
            <tr>
              <StyledTd>
                <code>
                  set consumer group rebalancing &lt;group&gt;
                  &lt;rebalancing&gt;
                </code>
              </StyledTd>
              <StyledTd>
            ...
            <tr>
              ...
              <StyledTd>
                <ul>
                  <li>
                    Plays back events for a given consumer from the offset.
                  </li>
                </ul>
              </StyledTd>
              <StyledTd>
