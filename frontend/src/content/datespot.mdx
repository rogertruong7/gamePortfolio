...
- **Role & Permission Enforcement**: `Role` enum defines `USER`, `MANAGER`, `ADMIN` with associated `Permission` sets; Spring Security ensures only authorised roles can access protected endpoints
